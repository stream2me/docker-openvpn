...
wget --no-check-certificate -O /app/openvpn/provider/smartdns.sh https://github.com/stream2me/docker-openvpn/raw/master/root/app/openvpn/provider/smartdns.sh;
